...
def build(args):
    ...
    # model = torch.load('FCBFormer.pt')
    # pretrained_dict = torch.load('FCBFormer.pt')
    ...
    pretrained_dict = torch.load('swinv2_small_patch4_window8_256.pth')
...
def train(args):
    ...
    for epoch in range(1, args.epochs + 1):
        try:
            ...
            writer.add_scalar('dice/test', test_measure_mean, epoch)
...
def get_args():
    ...
    # parser.add_argument("--dataset", type=str, choices="Kvasir")
    parser.add_argument("--dataset", type=str, default="Kvasir")
    parser.add_argument("--data-root", type=str, default=r'E:\study\fcbformers\Kvasir-SEG', dest="root")
    ...
    parser.add_argument(
        "--multi-gpu", type=str, default="false", dest="mgpu", choices= "False"
    )
    # parser.add_argument(
